#///////////////////////////////////////////////////////////////
#// Artery.py
#// Copyright (C) 2018 University of Toronto, created by Mehdi Najafi (mnuoft@gmail.com)
#// Altered 2022 by Anna Haley for BSLSolver v2.0
#///////////////////////////////////////////////////////////////

__author__ = "Mehdi Najafi <mnuoft@gmail.com> and Anna Haley <ahaley@mie.utoronto.ca>"
__date__ = "2018-2022"
__copyright__ = "Copyright (C) 2018-2022 U of T "
__license__  = "Private"
...
def pre_solve_hook(mesh, V, Q, newfolder, folder, u_, mesh_path,
    ...
    return dict(hdf5_link=h5stdio,
                ...
                timestep_cpu_time=0, current_time=time.time(), cpu_time=0, ftle_f=ftle_f, ftLe_backward=ftLe_backward, ftLe_forward=ftLe_forward, ftLe_intersect=ftLe_intersect, grad_sig)
...
def temporal_hook(u_, p_, p, q_, V, mesh, tstep, compute_flux,
                  ...
                  cpu_time, final_time, timesteps, not_zero_pressure_outlets,ftle_f, ftLe_forward, ftLe_backward, ftLe_intersect, grad_sig, **NS_namespace):
    ...
    if (current_cycle > 0) and (current_cycle <= total_cycles-1): #
        if tstep % store_data == 0:	
            ...
            if NS_parameters['save_ftle']:
                FTLE.get_ftle(ftLe_forward, ftLe_backward, ftLe_intersect, grad_sig, mesh, ftle_f, tstep)
            if mpi_rank == 0:
