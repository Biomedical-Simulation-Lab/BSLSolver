    ...
    def init_code(self):
        return compile_cpp_code('''
                        ...
                        dolfin::Function& pf)
            {
                ...
                const std::int64_t offset_u = MPI::global_offset(MPI_COMM_WORLD, local_shape_u, true);
                const std::int64_t offset_p = MPI::global_offset(MPI_COMM_WORLD, local_shape_p, true);
                ...
                hid_t hdf5_file_id = HDF5Interface::open_file(MPI_COMM_WORLD, filename, file_mode, use_mpi_io);
